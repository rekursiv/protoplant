...
public class WinderMinderPanelTest extends MotorPanel implements Runnable {

	private volatile boolean isMovingForward = true;
	private volatile boolean isPolling = false;
	private volatile Thread thread = null;

	public WinderMinderPanelTest(Composite parent, Injector injector, int boardIndex, String label) {
